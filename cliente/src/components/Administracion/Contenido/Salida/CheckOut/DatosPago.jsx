...
export default function DatosPago({mostrar,cancelar}) {
    return (
        ...
        <div className="input-contenido">
            ...
            <input className="form-control" type="text" placeholder="Numero Tarjeta"/>
        </div>
        <div className="fechas-tarjeta">
            <div className="input-contenido">
                <select className="form-control" name="" id="">
                    <option value="" selected="selected">Mes de Vencimiento</option>
            ...
            <div className="input-contenido">
                <select className="form-control" name="" id="">
                    <option value="" selected="selected">Año de vencimiento</option>
            ...
            <div className="input-contenido">
                <input className="form-control" type="text" placeholder="CVV" required="required" maxLength="4" autoComplete="off"/>
            </div>
        </div>
